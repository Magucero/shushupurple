  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-8 w-full max-w-7xl mx-auto">
        <div className="space-y-6">
            <div className="text-lg font-bold text-white font-['Space_Grotesk'] tracking-widest uppercase">PURPLE MONOLITH</div>
            <p className="text-slate-500 font-['Space_Grotesk'] text-xs tracking-widest max-w-xs leading-loose">
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-col space-y-2 text-slate-500 font-['Space_Grotesk'] text-[10px] tracking-widest">
            ...
            <div className="flex flex-col justify-end text-right">
                <p className="text-slate-500 font-['Space_Grotesk'] text-xs tracking-widest uppercase">© 2026 PURPLE MONOLITH. ALL RIGHTS RESERVED.</p>
            </div>
        </div>
    </div>
</footer>
