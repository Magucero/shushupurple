  ...
  return (
    <>   
      <section className="relative min-h-[921px] flex flex-col md:flex-row items-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-[#0e0e13] via-transparent to-transparent z-10"></div>
        
        <div className="relative z-20 w-full md:w-1/2 px-8 md:pl-20 py-12">
          <p className="font-label uppercase tracking-[0.4em] text-[#8ff5ff] mb-4 text-sm">
            ARCHIVE SERIES // 001
          </p>

          <h1 className="font-headline font-black text-6xl md:text-8xl tracking-tighter uppercase leading-[0.85] mb-8  ">
            TITAN <br /><span className="text-[#ff6b98]">PRO_X</span>
          </h1>

          <p className="text-[#acaab1] max-w-md mb-10 text-lg leading-relaxed">
            The ultimate artifact for those who traverse the digital void. Hall-effect switches meet aerospace-grade aluminum.
          </p>

          <button className="bg-[#8ff5ff] text-[#005d63] px-12 py-5 font-headline font-bold uppercase tracking-widest text-lg hero-glow hover:scale-105 active:scale-95 transition-all duration-300">
            SHOP NOW
          </button>
        </div>

        <div className="relative w-full md:w-1/2 h-[512px] md:h-[921px] flex items-center justify-center">
          <div className="absolute w-[120%] h-[120%] bg-radial-gradient from-[#8ff5ff]/10 to-transparent blur-3xl"></div>
          <img
      ...
      <section className="px-8 py-24 bg-[#000000]">
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 h-[1200px] md:h-[600px]">

          <div className="md:col-span-2 md:row-span-2 relative group overflow-hidden bg-[#1f1f26]">
            <img
              alt="Gaming Setup"
            ...
            <div className="absolute bottom-8 left-8">
              ...
              <p className="text-[#8ff5ff] font-label text-sm tracking-widest mt-2">
                COMPLETE KITS AVAILABLE
              </p>
            </div>
          </div>

          <div className="md:col-span-2 relative group overflow-hidden bg-[#1f1f26]">
            <img
              alt="Figures"
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#ff6b98]/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>

            <div className="absolute bottom-8 left-8">
              <h3 className="font-headline font-black text-3xl uppercase tracking-tighter">
                ANIME FIGURES
              </h3>
              <p className="text-[#ff6b98] font-label text-sm tracking-widest mt-2">
                RARE JAPAN IMPORTS
              </p>
            </div>
          </div>

          <div className="relative group overflow-hidden bg-[#1f1f26]">
            <div className="absolute inset-0 bg-[#25252c] flex items-center justify-center glass-artifact">
              <span
                className="material-symbols-outlined text-[#8ff5ff] text-6xl opacity-20"
            ...
            <div className="absolute inset-0 p-6 flex flex-col justify-end border border-white/0 group-hover:border-[#8ff5ff]/50 transition-colors">
              <h3 className="font-headline font-bold text-xl uppercase">MICE</h3>
              <p className="text-[#acaab1] text-xs mt-1">OPTICAL PRECISION</p>
            </div>
          </div>
          ...
          <div className="relative group overflow-hidden bg-[#1f1f26]">
            <div className="absolute inset-0 bg-[#25252c] flex items-center justify-center glass-artifact">
              <span
                className="material-symbols-outlined text-[#ff6b98] text-6xl opacity-20"
                style={{ fontVariationSettings: "'FILL' 1" }}
              >
                headphones
              </span>
            ...
            <div className="absolute inset-0 p-6 flex flex-col justify-end border border-white/0 group-hover:border-[#ff6b98]/50 transition-colors">
              <h3 className="font-headline font-bold text-xl uppercase">AUDIO</h3>
              <p className="text-[#acaab1] text-xs mt-1">SPATIAL IMMERSION</p>
            </div>
          </div>
      ...
      {/* New Arrivals: The Gloss Artifacts */}
...
<section className="px-8 py-24">
  <div className="flex justify-between items-end mb-12">
    <div>
      ...
      <div className="h-1 w-24 bg-[#8ff5ff] mt-4"></div>
    </div>
    <a
      className="font-label uppercase text-sm tracking-widest text-[#acaab1] hover:text-[#8ff5ff] transition-colors"
      href="#"
    >
      VIEW_ALL_COLLECTION
    </a>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
    ...
    {/* Product Card 1 */}
    <div className="bg-[#1f1f26] relative group">
      ...
      <div className="p-6">
        <div className="flex justify-between items-start mb-2">
          <span className="bg-[#ff6b98] px-2 py-1 text-[10px] font-bold tracking-widest text-[#47001d]">
            LIMITED_DROP
          </span>
          <span className="text-[#8ff5ff] font-headline font-black">$249.00</span>
        </div>

        <h4 className="font-headline font-bold text-lg uppercase tracking-tight">
          KAIZEN_SERIES: VALKYRIE
        </h4>
        <p className="text-[#acaab1] text-xs mt-1 uppercase tracking-widest">
          1/7 SCALE STATUE
        </p>

        <button className="w-full mt-6 border border-[#48474d] py-3 font-label text-sm uppercase tracking-[0.2em] hover:bg-[#f8f5fd] hover:text-[#0e0e13] transition-colors">
          ADD TO_CART
        </button>
      </div>
    </div>
    ...
    <div className="bg-[#1f1f26] relative group">
      ...
      <div className="p-6">
        <div className="flex justify-between items-start mb-2">
          <span className="bg-[#25252c] px-2 py-1 text-[10px] font-bold tracking-widest text-[#8ff5ff]">
            PRE_ORDER
          </span>
          <span className="text-[#8ff5ff] font-headline font-black">$185.00</span>
        </div>
    ...
    <div className="bg-[#1f1f26] relative group">
      ...
      <div className="p-6">
        <div className="flex justify-between items-start mb-2">
          <span className="bg-[#25252c] px-2 py-1 text-[10px] font-bold tracking-widest text-[#f8f5fd]">
            RESTOCKED
          </span>
          <span className="text-[#8ff5ff] font-headline font-black">$320.00</span>
        </div>
    ...
    <div className="bg-[#1f1f26] relative group">
      ...
      <div className="p-6">
        <div className="flex justify-between items-start mb-2">
          ...
          <span className="text-[#8ff5ff] font-headline font-black">$129.00</span>
        </div>
...
<section className="py-24 px-8 border-y border-[#48474d]/10">
  <div className="max-w-4xl mx-auto text-center">
    <h2 className="font-headline font-black text-5xl md:text-7xl uppercase tracking-tighter mb-8 leading-none">
      JOIN THE <span className="text-[#d674ff]">MONOLITH</span>
    </h2>

    <p className="font-body text-[#acaab1] text-lg mb-12 max-w-xl mx-auto">
      Access exclusive member-only drops, secret pre-order links, and rare artifact alerts.
    </p>

    <div className="flex flex-col md:flex-row gap-4">
      <input
        className="flex-grow bg-[#19191f] border-0 border-b-2 border-[#48474d] focus:ring-0 focus:border-[#8ff5ff] text-[#f8f5fd] font-label tracking-widest py-4 px-6 uppercase text-sm"
        placeholder="YOUR_ENCRYPTED_EMAIL"
        type="email"
      />

      <button className="bg-[#d674ff] text-[#390050] px-12 py-4 font-headline font-black uppercase tracking-widest hover:brightness-110 transition-all">
        CONNECT_IDENTITY
      </button>
    </div>
  </div>
